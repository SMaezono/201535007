...
root <- "C:/Users/Jiachen Liang/OneDrive - OnTheHub - The University of Oxford/Buffa Lab/apobec/Alexandrov_mut_sig/"
setwd(root)
...
for(i in 1:length(cancers)){
  ...
  target_file <- paste('C:/Users/Jiachen Liang/OneDrive - OnTheHub - The University of Oxford/Buffa Lab/apobec/data/2016/tumour/apobec/', cancers[i], '.txt', sep='')
  exp_a_t[[i]] <- read.table(file=target_file, sep='\t', header=T, row.names=1)
  target_file <- paste('C:/Users/Jiachen Liang/OneDrive - OnTheHub - The University of Oxford/Buffa Lab/apobec/data/2016/tumour/hypoxia/', cancers[i], '.txt', sep='')
...
root <- "C:/Users/Jiachen Liang/OneDrive - OnTheHub - The University of Oxford/Buffa Lab/apobec/Alexandrov_mut_sig/output_counts/"
setwd(root)
...
root <- "C:/Users/Jiachen Liang/OneDrive - OnTheHub - The University of Oxford/Buffa Lab/apobec/Alexandrov_mut_sig/output_counts/log/"
setwd(root)
...
root <- "C:/Users/Jiachen Liang/OneDrive - OnTheHub - The University of Oxford/Buffa Lab/apobec/Alexandrov_mut_sig/output_dcs/"
setwd(root)
...
root <- "C:/Users/Jiachen Liang/OneDrive - OnTheHub - The University of Oxford/Buffa Lab/apobec/Alexandrov_mut_sig/output_dcs/filtered/"
setwd(root)
...
thr_mat <- read.table("C:/Users/Jiachen Liang/OneDrive - OnTheHub - The University of Oxford/Buffa Lab/apobec/data/exp_med.txt", sep='\t', header=T, row.names=1)
