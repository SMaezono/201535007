...
fun1 <- function(year, state){
  ...
  for(m in methods){
    ...
    # Import data
    all.cor.mean <- read.table(file = paste("apobec/output/", year, "/", state, "/", m, "/mean_cor.txt", sep=""), sep = '\t', header = TRUE, row.names = 1)
    all.pv.mean <- read.table(file = paste("apobec/output/", year, "/", state, "/", m, "/mean_pv.txt", sep=""), sep = '\t', header = TRUE, row.names = 1)
    all.cor.median <- read.table(file = paste("apobec/output/", year, "/", state, "/", m, "/median_cor.txt", sep=""), sep = '\t', header = TRUE, row.names = 1)
    all.pv.median <- read.table(file = paste("apobec/output/", year, "/", state, "/", m, "/median_pv.txt", sep=""), sep = '\t', header = TRUE, row.names = 1)
    all.cor.pc1 <- read.table(file = paste("apobec/output/", year, "/", state, "/", m, "/pc1_cor.txt", sep=""), sep = '\t', header = TRUE, row.names = 1)
    all.pv.pc1 <- read.table(file = paste("apobec/output/", year, "/", state, "/", m, "/pc1_pv.txt", sep=""), sep = '\t', header = TRUE, row.names = 1)
    ...
    pdf(file=paste("apobec/output/", year, "/", state, "/", m, "/1_mean_alpha.pdf", sep=""), width=w, height=h)
    hm1 <- heatmap.2(
    ...
    pdf(file=paste("apobec/output/", year, "/", state, "/", m, "/2_median_alpha.pdf", sep=""), width=w, height=h)
    hm2 <- heatmap.2(
    ...
    pdf(file=paste("apobec/output/", year, "/", state, "/", m, "/3_pc1_alpha.pdf", sep=""), width=w, height=h)
    hm3 <- heatmap.2(
    ...
    pdf(file=paste("apobec/output/", year, "/", state, "/", m, "/4_mean_hm2.pdf", sep=""), width=w, height=h)
    hm4 <- heatmap.2(
      data.matrix(all.cor.mean),
    ...
    pdf(file=paste("apobec/output/", year, "/", state, "/", m, "/5_median_hm2.pdf", sep=""), width=w, height=h)
    hm5 <- heatmap.2(
      data.matrix(all.cor.median),
    ...
    pdf(file=paste("apobec/output/", year, "/", state, "/", m, "/6_pc1_hm2.pdf", sep=""), width=w, height=h)
    hm6 <- heatmap.2(
      data.matrix(all.cor.pc1),
    ...
    pdf(file=paste("apobec/output/", year, "/", state, "/", m, "/7_mean_hclust.pdf", sep=""), width=w, height=h)
    hm7 <- heatmap.2(
      data.matrix(all.cor.mean),
    ...
    pdf(file=paste("apobec/output/", year, "/", state, "/", m, "/8_median_hclust.pdf", sep=""), width=w, height=h)
    hm8 <- heatmap.2(
      data.matrix(all.cor.median),
    ...
    pdf(file=paste("apobec/output/", year, "/", state, "/", m, "/9_pc1_hclust.pdf", sep=""), width=w, height=h)
    hm9 <- heatmap.2(
      data.matrix(all.cor.pc1),
  ...
  for(m in methods){
    # Write to disk
    write.table(all.cor.mean, paste("apobec/output/", year, "/", state, "/", m, "/sig_mean_cor.txt", sep=""), sep='\t')
    write.table(all.cor.median, paste("apobec/output/", year, "/", state, "/", m, "/sig_median_cor.txt", sep=""), sep='\t')
    write.table(all.cor.pc1, paste("apobec/output/", year, "/", state, "/", m, "/sig_pc1_cor.txt", sep=""), sep='\t')
  }
