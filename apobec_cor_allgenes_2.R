...
sign <- as.character(read.table(paste(dir_p, 'sign_1.txt', sep=''), header=T, sep='\t')[,1])
...
write.table(mat_cor, file=paste('Buffa52/', cancer, '_cor.txt', sep=''), sep='\t')
write.table(mat_pv, file=paste('Buffa52/', cancer, '_pv.txt', sep=''), sep='\t')
...
write.table(mat_bin, file=paste('Buffa52/', cancer, '_bin.txt', sep=''), sep='\t')
write.table(mat_bin[mat_bin$Count>0,], file=paste('Buffa52/', cancer, '_list.txt', sep=''), sep='\t')
...
mat_sum <- mat_sum[rownames(mat_bin[mat_bin$Count>0,]),] # filter for genes at least correlated with one gene in signature
mat_sum <- mat_sum[order(-mat_sum)]
write.table(mat_sum, file=paste('Buffa52/', cancer, '_sum.txt', sep=''), sep='\t')
write.table(mat_sum[1:100], file=paste('Buffa52/', cancer, '_sum_top_100.txt', sep=''), sep='\t')
write.table(mat_sum[1:500], file=paste('Buffa52/', cancer, '_sum_top_500.txt', sep=''), sep='\t')
write.table(mat_sum[1:1000], file=paste('Buffa52/', cancer, '_sum_top_1000.txt', sep=''), sep='\t')
write.table(mat_sum[mat_sum>=10], file=paste('Buffa52/', cancer, '_sum_above10.txt', sep=''), sep='\t')
write.table(mat_sum[mat_sum>=1], file=paste('Buffa52/', cancer, '_sum_above1.txt', sep=''), sep='\t')
write(names(mat_sum[1:100]), file=paste('Buffa52/', cancer, '_genes_top_100.txt', sep=''))
write(names(mat_sum[1:500]), file=paste('Buffa52/', cancer, '_genes_top_500.txt', sep=''))
write(names(mat_sum[1:1000]), file=paste('Buffa52/', cancer, '_genes_top_1000.txt', sep=''))
write(names(mat_sum[mat_sum>=10]), file=paste('Buffa52/', cancer, '_genes_above10.txt', sep=''))
write(names(mat_sum[mat_sum>=1]), file=paste('Buffa52/', cancer, '_genes_above1.txt', sep=''))
