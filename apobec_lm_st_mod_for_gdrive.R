...
# this uses data/2016 and logged
...
if(win){
  ...
  # Directory: output
  dir.create('G:/My Drive/Jiachen Files/Sakura/output/lm_ST')
  dir_o <- 'G:/My Drive/Jiachen Files/Sakura/output/lm_ST/'
  ...
  # Directory: output
  dir_o <- '/Users/jiachen/OneDrive - OnTheHub - The University of Oxford/Buffa Lab/apobec/output/lm_ST/'
  
  # Directory: parameters
  dir_p <- '/Users/jiachen/OneDrive - OnTheHub - The University of Oxford/Buffa Lab/apobec/data/'
  
  # Directory: expression matrices
  dir_e <- '/Users/jiachen/OneDrive - OnTheHub - The University of Oxford/Buffa Lab/apobec/data/2016/'
}

# create directories
dir.create('G:/My Drive/Jiachen Files/Sakura/output/lm_ST/normal')
dir.create('G:/My Drive/Jiachen Files/Sakura/output/lm_ST/normal/PCA')
dir.create('G:/My Drive/Jiachen Files/Sakura/output/lm_ST/tumour')
dir.create('G:/My Drive/Jiachen Files/Sakura/output/lm_ST/tumour/PCA')
dir.create('G:/My Drive/Jiachen Files/Sakura/output/lm_ST/normal/scatterplots')
dir.create('G:/My Drive/Jiachen Files/Sakura/output/lm_ST/tumour/scatterplots')
dir.create('G:/My Drive/Jiachen Files/Sakura/output/lm_ST/normal/LM')
dir.create('G:/My Drive/Jiachen Files/Sakura/output/lm_ST/tumour/LM')
dir.create('G:/My Drive/Jiachen Files/Sakura/output/lm_ST/normal/hyp vs pc')
dir.create('G:/My Drive/Jiachen Files/Sakura/output/lm_ST/tumour/hyp vs pc')
###############################################################################################
# Parameters
###############################################################################################
...
for(cancer_index in 1:length(cancers)) {
  ...
  for(i in 1:nrow(mat_n)){ # for every APOBEC
    for(j in 1:ncol(good_pc_n)){ # for every PC
      ...
      dir <- paste(dir_o, 'normal/scatterplots/', cancer, '_', colnames(good_pc_n)[j], '_', rownames(mat_n)[i], '.pdf', sep='')
      Original <- c() # original data
      PC <- c() # principal component
